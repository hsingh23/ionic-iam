 ...
 * @usage
 * ```js
 * var iam = angular.module('reallyCoolApp', ['ionic']);
 *
 * iam.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('iam', ['ionic'])
 ...
 *
 * ```
 * angular.module('iam', ['ngRoute'])`
 * ```
 *
 * becomes
 *
 * ```
 * angular.module('iam', ['ngRoute', 'ngIOS9UIWebViewPatch'])
 * ```
 *
 *
 * More info:
